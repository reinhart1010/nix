...
<a class="btn btn-primary" href="{{ site.url }}/en/common/source.html">View original (English) version</a>
...
`source `<span class="tldr-var badge badge-pill bg-dark-lm bg-white-dm text-white-lm text-dark-dm font-weight-bold">väg/till/fil</span>
