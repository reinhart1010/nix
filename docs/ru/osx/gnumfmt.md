---
layout: page
title: osx/gnumfmt (русский)
description: "Эта команда — псевдоним для `-p linux numfmt`."
content_hash: 8e210097164569a0d1d7ffc0520f2ffb2b7da050
...
Эта команда — псевдоним для `-p linux numfmt`.
