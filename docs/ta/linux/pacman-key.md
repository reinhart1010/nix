...
content_hash: 276ee270fde335696bcf65a5dd04d927bdb7e312
...
`sudo pacman-key --add `<span class="tldr-var badge badge-pill bg-dark-lm bg-white-dm text-white-lm text-dark-dm font-weight-bold">விசைக்கோப்பு.gpg/பாதை</span>
