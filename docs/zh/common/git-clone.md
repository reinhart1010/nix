...
content_hash: 1000ba34ec50f3a005745b15f1e9b4941bd34502
...
`git clone `<span class="tldr-var badge badge-pill bg-dark-lm bg-white-dm text-white-lm text-dark-dm font-weight-bold">远程代码库地址</span>
...
`git clone -l `<span class="tldr-var badge badge-pill bg-dark-lm bg-white-dm text-white-lm text-dark-dm font-weight-bold">路径/到/本地/代码库名</span>

- 静默克隆，不打印任何日志：

`git clone -q `<span class="tldr-var badge badge-pill bg-dark-lm bg-white-dm text-white-lm text-dark-dm font-weight-bold">远程代码库地址</span>
