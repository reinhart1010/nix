---
layout: page
title: osx/ginstall (українська)
description: "Ця команда є псевдонімом для `-p linux install`."
content_hash: d12f115cca77726338c8509e7cb4f8408776c645
...
Ця команда є псевдонімом для `-p linux install`.
