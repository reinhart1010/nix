---
layout: page
title: osx/gsha1sum (română)
description: "Această comandă este un alias al `-p linux sha1sum`."
content_hash: 1103de14a695df3fde1287bf907f65ba84ddd4eb
...
Această comandă este un alias al `-p linux sha1sum`.
