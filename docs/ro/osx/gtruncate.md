---
layout: page
title: osx/gtruncate (română)
description: "Această comandă este un alias al `-p linux truncate`."
content_hash: 7027cae0682d5c507241eb25b1e2a883da68b5f3
...
Această comandă este un alias al `-p linux truncate`.
