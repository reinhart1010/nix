---
layout: page
title: osx/glibtoolize (română)
description: "Această comandă este un alias al `-p linux libtoolize`."
content_hash: b321056eb9c38216b2dfbd62c7ddc28c8099858f
...
Această comandă este un alias al `-p linux libtoolize`.
