---
layout: page
title: netbsd/sed (English)
description: "Edit text in a scriptable manner."
content_hash: ead5a532459a74899560d33846d576f2778ce28a
...
<span class="tldr-var badge badge-pill bg-dark-lm bg-white-dm text-white-lm text-dark-dm font-weight-bold">command</span>` | sed -fg `<span class="tldr-var badge badge-pill bg-dark-lm bg-white-dm text-white-lm text-dark-dm font-weight-bold">path/to/script.sed</span>
