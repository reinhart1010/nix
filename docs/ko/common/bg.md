...
layout: page
title: common/bg (한국어)
description: "일시 중단된 작업을 다시 시작하고 (예. `Ctrl + Z`), 그 작업이 background에서 동작하게 유지."
content_hash: 34879158fdc509ea339cbd596658cbe9f4a96162
related_topics:
...
`bg %`<span class="tldr-var badge badge-pill bg-dark-lm bg-white-dm text-white-lm text-dark-dm font-weight-bold">job_id</span>
