---
layout: page
title: linux/a2disconf (한국어)
description: "Debian 기반 운영체제에서 Apache 구성 파일을 비활성화합니다."
content_hash: e73df1ea5b42ce451bc8e3662f55974536e406ef
...
`sudo a2disconf `<span class="tldr-var badge badge-pill bg-dark-lm bg-white-dm text-white-lm text-dark-dm font-weight-bold">구성_파일</span>

- 정보 메시지를 표시하지 않음:

`sudo a2disconf --quiet `<span class="tldr-var badge badge-pill bg-dark-lm bg-white-dm text-white-lm text-dark-dm font-weight-bold">구성_파일</span>
