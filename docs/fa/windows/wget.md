---
layout: page
title: windows/wget (فارسی)
description: "این دستور یک نام مستعار از `wget -p common` است."
content_hash: df83abaf57a8a4cacbf6df4dd38dce701a685638
...
این دستور یک نام مستعار از `wget -p common` است.
