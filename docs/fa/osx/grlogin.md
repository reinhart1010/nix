---
layout: page
title: osx/grlogin (فارسی)
description: "این دستور یک نام مستعار از `-p linux rlogin` است."
content_hash: 67453f03d248b5836b12da6dce1ff33d2bc16eda
...
این دستور یک نام مستعار از `-p linux rlogin` است.
