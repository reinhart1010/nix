---
layout: page
title: osx/gnohup (فارسی)
description: "این دستور یک نام مستعار از `-p linux nohup` است."
content_hash: 047d3bbdb3cf83d5b973a812507ce2988c8fdae7
...
این دستور یک نام مستعار از `-p linux nohup` است.
