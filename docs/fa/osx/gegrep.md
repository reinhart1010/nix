---
layout: page
title: osx/gegrep (فارسی)
description: "این دستور یک نام مستعار از `-p linux egrep` است."
content_hash: 2ce33dd8cb6d10e6f2e830feaaecf57e71bd659b
...
این دستور یک نام مستعار از `-p linux egrep` است.
