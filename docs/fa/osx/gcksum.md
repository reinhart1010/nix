---
layout: page
title: osx/gcksum (فارسی)
description: "این دستور یک نام مستعار از `-p linux cksum` است."
content_hash: 9678d8f39d7b30747afeac6c60c15cd764fdd332
...
این دستور یک نام مستعار از `-p linux cksum` است.
