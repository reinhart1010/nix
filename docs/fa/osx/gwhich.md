---
layout: page
title: osx/gwhich (فارسی)
description: "این دستور یک نام مستعار از `-p linux which` است."
content_hash: d322524cdc4eff3b38d4f42a3f62f9b236d2e0a1
...
این دستور یک نام مستعار از `-p linux which` است.
