---
layout: page
title: osx/gsort (فارسی)
description: "این دستور یک نام مستعار از `-p linux sort` است."
content_hash: b7a3583634853c1721c5f696fde2695ad1bc0d07
...
این دستور یک نام مستعار از `-p linux sort` است.
