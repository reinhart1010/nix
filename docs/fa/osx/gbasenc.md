---
layout: page
title: osx/gbasenc (فارسی)
description: "این دستور یک نام مستعار از `-p linux basenc` است."
content_hash: 31a2949eea8d93f3f6c4701292fa705a00e9e980
...
این دستور یک نام مستعار از `-p linux basenc` است.
