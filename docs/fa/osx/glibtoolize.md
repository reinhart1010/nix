---
layout: page
title: osx/glibtoolize (فارسی)
description: "این دستور یک نام مستعار از `-p linux libtoolize` است."
content_hash: f25e8af43c7cbde07280a0ccab65d978d8a8e7d4
...
این دستور یک نام مستعار از `-p linux libtoolize` است.
