---
layout: page
title: osx/gnproc (فارسی)
description: "این دستور یک نام مستعار از `-p linux nproc` است."
content_hash: af70160a60862cd5668a4e3f9c9ce46bd089f6ff
...
این دستور یک نام مستعار از `-p linux nproc` است.
