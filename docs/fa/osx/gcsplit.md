---
layout: page
title: osx/gcsplit (فارسی)
description: "این دستور یک نام مستعار از `-p linux csplit` است."
content_hash: 9ee11aeabcffe1993286c7b50d69552ff55672bf
...
این دستور یک نام مستعار از `-p linux csplit` است.
