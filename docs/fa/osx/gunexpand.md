---
layout: page
title: osx/gunexpand (فارسی)
description: "این دستور یک نام مستعار از `-p linux unexpand` است."
content_hash: e955acbdbf23b015f09ee9eee1198128cff81e8a
...
این دستور یک نام مستعار از `-p linux unexpand` است.
