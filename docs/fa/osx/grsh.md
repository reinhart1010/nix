---
layout: page
title: osx/grsh (فارسی)
description: "این دستور یک نام مستعار از `-p linux rsh` است."
content_hash: 8f367c1a98497a72f7690225228d3b679a7f2e11
...
این دستور یک نام مستعار از `-p linux rsh` است.
