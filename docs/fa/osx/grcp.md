---
layout: page
title: osx/grcp (فارسی)
description: "این دستور یک نام مستعار از `-p linux rcp` است."
content_hash: 1976a99daf04c67c212ad5abe096cf4f7ee78796
...
این دستور یک نام مستعار از `-p linux rcp` است.
