---
layout: page
title: osx/gstdbuf (فارسی)
description: "این دستور یک نام مستعار از `-p linux stdbuf` است."
content_hash: ae5f51c4fbae06d6c46263823c13c6f4e9c030a5
...
این دستور یک نام مستعار از `-p linux stdbuf` است.
