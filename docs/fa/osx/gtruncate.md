---
layout: page
title: osx/gtruncate (فارسی)
description: "این دستور یک نام مستعار از `-p linux truncate` است."
content_hash: a73097d57df6bd785b01dfe10b26dde45841aa54
...
این دستور یک نام مستعار از `-p linux truncate` است.
