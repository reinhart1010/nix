---
layout: page
title: osx/glocate (فارسی)
description: "این دستور یک نام مستعار از `-p linux locate` است."
content_hash: 847d9c4bfbd8d760c455ffc97b25329229654812
...
این دستور یک نام مستعار از `-p linux locate` است.
