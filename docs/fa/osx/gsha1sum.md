---
layout: page
title: osx/gsha1sum (فارسی)
description: "این دستور یک نام مستعار از `-p linux sha1sum` است."
content_hash: 981a47fc0761a4ea656de9dfb907c892e47d7c1f
...
این دستور یک نام مستعار از `-p linux sha1sum` است.
