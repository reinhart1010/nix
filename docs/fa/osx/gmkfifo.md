---
layout: page
title: osx/gmkfifo (فارسی)
description: "این دستور یک نام مستعار از `-p linux mkfifo` است."
content_hash: 6a31eee252b4f0a2050a4479a17feb83397af910
...
این دستور یک نام مستعار از `-p linux mkfifo` است.
