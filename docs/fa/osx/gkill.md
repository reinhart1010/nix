---
layout: page
title: osx/gkill (فارسی)
description: "این دستور یک نام مستعار از `-p linux kill` است."
content_hash: aff9ea8155cb55a879f436e06969050d22bb27d9
...
این دستور یک نام مستعار از `-p linux kill` است.
