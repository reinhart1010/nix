---
layout: page
title: osx/gchgrp (فارسی)
description: "این دستور یک نام مستعار از `-p linux chgrp` است."
content_hash: b9f0b2f5cba3cc7880fb266546073fbbe8f49489
...
این دستور یک نام مستعار از `-p linux chgrp` است.
