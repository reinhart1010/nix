---
layout: page
title: osx/glogger (فارسی)
description: "این دستور یک نام مستعار از `-p linux logger` است."
content_hash: d635a937d41e062b5699e40afe1b8eee533d6b99
...
این دستور یک نام مستعار از `-p linux logger` است.
