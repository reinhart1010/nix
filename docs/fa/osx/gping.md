---
layout: page
title: osx/gping (فارسی)
description: "این دستور یک نام مستعار از `-p linux ping` است."
content_hash: 04034532195542c3069e487cc48a5ef9dee893b9
...
این دستور یک نام مستعار از `-p linux ping` است.
