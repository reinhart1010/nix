---
layout: page
title: osx/gsed (فارسی)
description: "این دستور یک نام مستعار از `-p linux sed` است."
content_hash: df29152575324d8e816124bd3c6ccf473d5f105c
...
این دستور یک نام مستعار از `-p linux sed` است.
