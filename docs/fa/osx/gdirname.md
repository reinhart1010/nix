---
layout: page
title: osx/gdirname (فارسی)
description: "این دستور یک نام مستعار از `-p linux dirname` است."
content_hash: 1ac75d0adf3d7537ba9ced6443445e09b5cf11ca
...
این دستور یک نام مستعار از `-p linux dirname` است.
