---
layout: page
title: osx/gyes (فارسی)
description: "این دستور یک نام مستعار از `-p linux yes` است."
content_hash: b4f5123100b3fd203a04acb3ce1d28595a5fcfb2
...
این دستور یک نام مستعار از `-p linux yes` است.
