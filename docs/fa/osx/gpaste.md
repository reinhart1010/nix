---
layout: page
title: osx/gpaste (فارسی)
description: "این دستور یک نام مستعار از `-p linux paste` است."
content_hash: c9d7900389685074062bee1ce9b57932f84fc851
...
این دستور یک نام مستعار از `-p linux paste` است.
