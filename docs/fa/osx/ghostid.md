---
layout: page
title: osx/ghostid (فارسی)
description: "این دستور یک نام مستعار از `-p linux hostid` است."
content_hash: 21697e18653ae8be6f3486f13e4e860acfe6f6d1
...
این دستور یک نام مستعار از `-p linux hostid` است.
