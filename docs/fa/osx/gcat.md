---
layout: page
title: osx/gcat (فارسی)
description: "این دستور یک نام مستعار از `-p linux cat` است."
content_hash: ea364cb80121c4a5b1227fa03662765b43cf729f
...
این دستور یک نام مستعار از `-p linux cat` است.
