---
layout: page
title: osx/gexpand (فارسی)
description: "این دستور یک نام مستعار از `-p linux expand` است."
content_hash: f7d1b218f4df207dcfd5c949dda4e17460b1d74d
...
این دستور یک نام مستعار از `-p linux expand` است.
