---
layout: page
title: osx/gtouch (فارسی)
description: "این دستور یک نام مستعار از `-p linux touch` است."
content_hash: 65eda75ce40d2ffb8ba5c09928f02236f7b38188
...
این دستور یک نام مستعار از `-p linux touch` است.
