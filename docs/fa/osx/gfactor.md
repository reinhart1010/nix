---
layout: page
title: osx/gfactor (فارسی)
description: "این دستور یک نام مستعار از `-p linux factor` است."
content_hash: 62cc571c909d70994c32409ea5b6e25e6ddcebfc
...
این دستور یک نام مستعار از `-p linux factor` است.
