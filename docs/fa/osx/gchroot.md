---
layout: page
title: osx/gchroot (فارسی)
description: "این دستور یک نام مستعار از `-p linux chroot` است."
content_hash: 1d424de6808d05edb3fc1b9939d569c85a373506
...
این دستور یک نام مستعار از `-p linux chroot` است.
