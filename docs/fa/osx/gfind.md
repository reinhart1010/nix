---
layout: page
title: osx/gfind (فارسی)
description: "این دستور یک نام مستعار از `-p linux find` است."
content_hash: 5042dd85096cc600c0584805df0c57734c83a6fb
...
این دستور یک نام مستعار از `-p linux find` است.
