---
layout: page
title: osx/genv (فارسی)
description: "این دستور یک نام مستعار از `-p linux env` است."
content_hash: 2d6699001351a12abe5ff72143aed3cc0a694ae0
...
این دستور یک نام مستعار از `-p linux env` است.
