---
layout: page
title: osx/gmkdir (فارسی)
description: "این دستور یک نام مستعار از `-p linux mkdir` است."
content_hash: cd4832d3876fd813c12cf29478bbb0101680b02f
...
این دستور یک نام مستعار از `-p linux mkdir` است.
