---
layout: page
title: osx/ggroups (فارسی)
description: "این دستور یک نام مستعار از `-p linux groups` است."
content_hash: 3d7a2c6fbad619f05f7c8c2c16f7774d62cd8709
...
این دستور یک نام مستعار از `-p linux groups` است.
