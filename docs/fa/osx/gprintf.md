---
layout: page
title: osx/gprintf (فارسی)
description: "این دستور یک نام مستعار از `-p linux printf` است."
content_hash: cb20b1c1184658266e44741437b45ce607885fc1
...
این دستور یک نام مستعار از `-p linux printf` است.
