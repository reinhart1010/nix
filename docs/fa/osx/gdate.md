---
layout: page
title: osx/gdate (فارسی)
description: "این دستور یک نام مستعار از `-p linux date` است."
content_hash: e896405206fda17044c42f4d275e08fa1fc1035b
...
این دستور یک نام مستعار از `-p linux date` است.
