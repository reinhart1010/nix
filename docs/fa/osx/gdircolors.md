---
layout: page
title: osx/gdircolors (فارسی)
description: "این دستور یک نام مستعار از `-p linux dircolors` است."
content_hash: b9701e9e24aa49b61179f04671de9ba8ad97c101
...
این دستور یک نام مستعار از `-p linux dircolors` است.
