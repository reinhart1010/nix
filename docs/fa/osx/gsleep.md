---
layout: page
title: osx/gsleep (فارسی)
description: "این دستور یک نام مستعار از `-p linux sleep` است."
content_hash: b88958bcc2d400897eba39aaf9567613fa2b9bc5
...
این دستور یک نام مستعار از `-p linux sleep` است.
