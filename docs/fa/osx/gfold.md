---
layout: page
title: osx/gfold (فارسی)
description: "این دستور یک نام مستعار از `-p linux fold` است."
content_hash: a61d06d432f5019134d4945a30b3927e27efe215
...
این دستور یک نام مستعار از `-p linux fold` است.
