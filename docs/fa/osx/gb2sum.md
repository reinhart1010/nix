---
layout: page
title: osx/gb2sum (فارسی)
description: "این دستور یک نام مستعار از `-p linux b2sum` است."
content_hash: aed660c390c4b693c71c9fb7f95550df5c7d3625
...
این دستور یک نام مستعار از `-p linux b2sum` است.
