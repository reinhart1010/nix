---
layout: page
title: osx/gtime (فارسی)
description: "این دستور یک نام مستعار از `-p linux time` است."
content_hash: 82c40dbe0952da0d079deecde1b389cb46ec0585
...
این دستور یک نام مستعار از `-p linux time` است.
