---
layout: page
title: osx/gsha384sum (فارسی)
description: "این دستور یک نام مستعار از `-p linux sha384sum` است."
content_hash: c8295d717f8a29de149d1bab3214d9727324081a
...
این دستور یک نام مستعار از `-p linux sha384sum` است.
