---
layout: page
title: osx/gusers (فارسی)
description: "این دستور یک نام مستعار از `-p linux users` است."
content_hash: 64677cc434cb44136d89e22eae244ed94c9406c7
...
این دستور یک نام مستعار از `-p linux users` است.
