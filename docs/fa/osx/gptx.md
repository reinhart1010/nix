---
layout: page
title: osx/gptx (فارسی)
description: "این دستور یک نام مستعار از `-p linux ptx` است."
content_hash: c1ff1077efccf38168bdb17c2a4a1efa1197d7f1
...
این دستور یک نام مستعار از `-p linux ptx` است.
