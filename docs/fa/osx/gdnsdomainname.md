---
layout: page
title: osx/gdnsdomainname (فارسی)
description: "این دستور یک نام مستعار از `-p linux dnsdomainname` است."
content_hash: 745a6df05de94ebd7a930ef86e2b3ca07a9a23c4
...
این دستور یک نام مستعار از `-p linux dnsdomainname` است.
