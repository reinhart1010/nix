---
layout: page
title: windows/choco-info (Deutsch)
description: "Zeige ausführliche Informationen über ein Chocolatey-Paket an."
content_hash: 9502a3ad514b8a958ebac094c1e9bf062f8bb301
related_topics:
...
`choco info `<span class="tldr-var badge badge-pill bg-dark-lm bg-white-dm text-white-lm text-dark-dm font-weight-bold">paket</span>

- Zeige Informationen über ein bestimmtes lokales Paket an:

`choco info `<span class="tldr-var badge badge-pill bg-dark-lm bg-white-dm text-white-lm text-dark-dm font-weight-bold">paket</span>` --local-only`

- Gib eine eigene Quelle an, von der Paket-Informationen abgerufen werden:

`choco info `<span class="tldr-var badge badge-pill bg-dark-lm bg-white-dm text-white-lm text-dark-dm font-weight-bold">paket</span>` --source `<span class="tldr-var badge badge-pill bg-dark-lm bg-white-dm text-white-lm text-dark-dm font-weight-bold">quell_url|alias</span>
